                     ...
                     GKeyFile *dst)
{
   const ConfigEntry entries[] = {
      ...
      /* guestd options. */
      { CONFNAME_GUESTINFO_DISABLEQUERYDISKINFO, CONFGROUPNAME_GUESTINFO, CONFNAME_GUESTINFO_DISABLEQUERYDISKINFO, CFG_BOOLEAN, NULL },
      { CONFNAME_GUESTINFO_NICPREFIX, CONFGROUPNAME_GUESTINFO, CONFNAME_GUESTINFO_NICPREFIX, CFG_STRING, NULL }, 
